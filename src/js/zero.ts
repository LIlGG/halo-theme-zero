...
class ZeroDocumentFunctionFactory implements DocumentFunctionFactory {
...
export class ZeroApp implements Zero {
  ...
  private documentFunctionFactory: DocumentFunctionFactory = new ZeroDocumentFunctionFactory();

  private events: Map<String, Event> = new Map();

  public readonly REFRESH_EVENT_NAME: String = "zero:refresh"
  ...
  protected obtainFunctionFactory(): DocumentFunctionFactory {
    if (!this.documentFunctionFactory) {
      this.documentFunctionFactory = new ZeroDocumentFunctionFactory();
    }
...
export let zero: Zero;

document.addEventListener('DOMContentLoaded', () => {
  zero = new ZeroApp(config);
  zero.refresh();
})
